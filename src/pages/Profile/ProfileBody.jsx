    ...
    <div>
        <main className='profile-page'>
            ...
            <section className='relative block' style={{height:"500px"}}>
                ...
                <div className='absolue top-0 w-full h-full bg-center bg-cover' style={{
                        ...
                        <div className="px-6">
                            <div className="flex flex-wrap justify-center">
                                ...
                                <div className="w-full lg:w-4/12 px-4 lg:order-3 lg:text-right lg:self-center">
                                        ...
                                        <button className="bg-pink-500 active:bg-pink-600 uppercase text-white font-bold hover:shadow-md shadow text-xs px-4 py-2 rounded outline-none focus:outline-none sm:mr-2 mb-1" type="button" style={{ transition: "all .15s ease" }}>Add friend</button>
                                        </div>
                                </div>
                            </div>
                            ...
                            <div className="mt-10 py-10 border-t border-gray-300 text-center">
                                <div className="flex flex-wrap justify-center">
                                    ...
                                    <p className="mb-4 text-lg leading-relaxed text-gray-800">An artist of considerable range, Jenna the name taken by Melbourne-raised, Brooklyn-based Nick Murphy writes, performs and records all of his own music, giving it a warm, intimate feel with a solid groove structure. An artist of considerable range.</p>
                                    <a href="#pablo" className="font-normal text-pink-500" onClick={e => e.preventDefault()}>Show more</a>
                                    </div> 
                                </div>
                            </div>
                        </div>
